...
const EXACT_SPECIFIER_MAPPINGS = new Map([
  ...
  ["@gouvfr-lasuite/cunningham-react/icons", `${PACKAGES.components}/fonts/material-icons`],
  ["@gouvfr-lasuite/cunningham-react/sass/icons", `${PACKAGES.components}/sass/fonts/material-icons`],
  ["@gouvfr-lasuite/cunningham-tokens", PACKAGES.tokens],
  ...
  ["@openfun/cunningham-react/icons", `${PACKAGES.components}/fonts/material-icons`],
  ["@openfun/cunningham-react/sass/icons", `${PACKAGES.components}/sass/fonts/material-icons`],
  ["@openfun/cunningham-tokens", PACKAGES.tokens],
