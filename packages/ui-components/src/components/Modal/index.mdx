...
<Source
  ...
  dark
  format={false}
  code={`import { Modal } from "@gouvfr-lasuite/ui-components";`}
/>
...
<Source
  ...
  format={false}
  code={`
import { CunninghamProvider, Button, Modal } from "@gouvfr-lasuite/ui-components";
...
<Source
  ...
  format={false}
  code={`
import { CunninghamProvider, Button, Modal, ModalSize, ModalTab, useModal } from "@gouvfr-lasuite/ui-components";
