...
- Publish the Cunningham token and theming engine under the canonical
  `@gouvfr-lasuite/ui-tokens` package.
- Preserve the `cunningham` CLI, the `cunningham-tokens.*` generated filenames,
  the `--c--` CSS prefix and the default token public path.
- Export `buildRefs`, `getThemesFromGlobals`, default tokens, default themes and
  token references for JavaScript and TypeScript consumers.

### Historical Cunningham token releases

The entries below were published under
...
[unreleased]: https://github.com/suitenumerique/cunningham/compare/@gouvfr-lasuite/ui-tokens@3.2.0...main
[3.2.0]: https://github.com/suitenumerique/cunningham/compare/@gouvfr-lasuite/ui-tokens@3.1.0...@gouvfr-lasuite/ui-tokens@3.2.0
[3.1.0]: https://github.com/suitenumerique/cunningham/compare/@openfun/cunningham-tokens@3.0.0...@gouvfr-lasuite/ui-tokens@3.1.0
