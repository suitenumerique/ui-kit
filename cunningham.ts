  ...
  themes: {
    default: {
      ...
      components: {
        ...
        tooltip: {
          padding: "4px 8px",
          "background-color": "ref(--c--theme--colors--greyscale-1000)",
        },
        button: {
          "medium-height": "40px",
          ...
          "small-height": "26px",
          primary: {
            "background--color": "ref(--c--theme--colors--primary-text)",
            "background--color-hover": "#1212ff",
            "background--color-active": "#2323ff",
            "background--color-disabled":
              "ref(--c--theme--colors--greyscale-100)",
            color: "#fff",
            "color-hover": "#fff",
            "color-active": "#fff",
            "color-focus-visible": "#fff",
            disabled: "ref(--c--theme--colors--greyscale-500)",
          },
          "primary-text": {
            "background--color": "ref(--c--theme--colors--primary-text)",
            "background--color-hover": "ref(--c--theme--colors--greyscale-100)",
            "background--color-active": "ref(--c--theme--colors--primary-100)",
            "background--color-focus-visible": "#fff",
            "background--color-disabled":
              "ref(--c--theme--colors--greyscale-000)",
            color: "ref(--c--theme--colors--primary-800)",
            "color-hover": "ref(--c--theme--colors--primary-800)",
            disabled: "ref(--c--theme--colors--greyscale-400)",
          },
          secondary: {
            ...
            "background--color-focus-visible":
              "ref(--c--theme--colors--greyscale-000)",
            "background--disabled": "ref(--c--theme--colors--greyscale-000)",
            color: "ref(--c--theme--colors--primary-800)",
            "border--color": "ref(--c--theme--colors--greyscale-300)",
            "border--color-hover": "ref(--c--theme--colors--greyscale-300)",
            "border--color-disabled": "ref(--c--theme--colors--greyscale-300)",
            disabled: "ref(--c--theme--colors--greyscale-400)",
          },
          tertiary: {
            "background--color": "ref(--c--theme--colors--primary-100)",
            "background--color-focus-visible":
              "ref(--c--theme--colors--primary-100)",
            "background--color-hover": "ref(--c--theme--colors--primary-300)",
            "background--color-active": "ref(--c--theme--colors--primary-300)",
            "background--disabled": "ref(--c--theme--colors--primary-050)",
            color: "ref(--c--theme--colors--primary-800)",
            disabled: "ref(--c--theme--colors--primary-300)",
          },
          "tertiary-text": {
            "background--color-hover": "ref(--c--theme--colors--greyscale-100)",
            "color-hover": "ref(--c--theme--colors--primary-text)",
            color: "ref(--c--theme--colors--primary-600)",
          },
          danger: {
            "color-hover": "white",
            "background--color": "ref(--c--theme--colors--danger-600)",
            "background--color-hover": "#FF2725",
            "background--color-focus-visible":
              "ref(--c--theme--colors--danger-600)",
            "background--color-disabled":
              "ref(--c--theme--colors--greyscale-100)",
            "color-disabled": "ref(--c--theme--colors--greyscale-400)",
          },
        },
        datagrid: {
        ...
        "forms-checkbox": {
          "border-radius": "4px",
          "border-color": "ref(--c--theme--colors--primary-800)",
          "background-color--hover": "ref(--c--theme--colors--greyscale-100)",
          "border--color-disabled": "ref(--c--theme--colors--greyscale-200)",
          "border--color": "ref(--c--theme--colors--primary-800)",
          "background--disabled": "ref(--c--theme--colors--greyscale-200)",
          "background--enable": "ref(--c--theme--colors--primary-800)",
          "check--disabled": "ref(--c--theme--colors--greyscale-300)",
          "check--enable": "ref(--c--theme--colors--greyscale-000)",
          color: "ref(--c--theme--colors--primary-text)",
          "label--color": "ref(--c--theme--colors--greyscale-1000)",
          "label--size": "ref(--c--theme--font--sizes--sm)",
          "label--weight": "500",
          "text--color": "ref(--c--theme--colors--greyscale-600)",
          "text--size": "ref(--c--theme--font--sizes--s)",
          "text--weight": "400",
          "text--color-disabled": "ref(--c--theme--colors--greyscale-300)",
        },
        "forms-labelledbox": {
        ...
        "forms-radio": {
          "border-color": "ref(--c--theme--colors--primary-800)",
          "background-color": "ref(--c--theme--colors--greyscale-000)",
          "accent-color": "ref(--c--theme--colors--primary-800)",
          "accent-color-disabled": "ref(--c--theme--colors--greyscale-300)",
        },
        "forms-switch": {
          "border--color-disabled": "ref(--c--theme--colors--greyscale-300)",
          "border--color": "ref(--c--theme--colors--primary-800)",
