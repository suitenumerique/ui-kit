...
- [x] 1.2 Create types file with `ContextMenuItem` and component prop types
...
- [x] 3.4 Support static menu array and dynamic menu function with context
- [x] 3.5 Handle `disabled` prop to skip menu opening

## 4. Menu Item Rendering

- [x] 4.1 Render menu items with label, icon, and onClick handler
- [x] 4.2 Support `hidden` prop to conditionally exclude items
- [x] 4.3 Support `disabled` prop with visual styling and prevented action
